    ...
    UI: {
      ...
      setupEventListeners: function () {
        ...
        sendButton.addEventListener('click', (event) => {
          ...
          if (!this.transcriberListening) {
            this.transcriber.start();
            this.transcriberListening = true;
            sendButton.innerHTML = micIconSvg;
          } else {
            this.transcriber.stop();
            this.transcriberListening = false;
            sendButton.innerHTML = micMutedIconSvg;
          }
        });
        ...
        this.transcriber = new Moonshine.MicrophoneTranscriber(
          "model/base",
          {
